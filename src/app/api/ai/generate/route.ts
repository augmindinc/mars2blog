    ...
    try {
        ...
        if (type === 'experience-to-post') {
            ...
            const prompt = `
                ...
                우리의 브랜드 보이스는 다음과 같다:
                "우리는 상품을 설명하지 않습니다. 어떤 선택이 어떤 하루를 만들었는지를 기록합니다. 확신 대신 회고를, 결론 대신 질문을 남깁니다."
                ...
                - 커머스형 (에세이형 커머스 템플릿 적용):
                    ...
                    2. 망설임: 바로 사지 않았다는 기록 (충동구매가 아님을 보여주며 신뢰 형성)
                    3. 선택의 이유: 기능 설명 (스펙 나열이 아닌, 기능을 경험으로 번역. 예: "500ml 대용량" -> "오후까지는 신경 쓸 일이 없었습니다")
                    4. 사용 후 변화: 하루의 변화 (과장 금지. "삶이 아니라 하루가 조금 덜 번거로워졌어요")
                    5. 솔직한 배제: 안 맞을 수도 있는 사람 (단점을 솔직하게 언급하여 신뢰 강화)
                ...
                STEP 3. 유형별 리프레이밍: ${contentType}에 맞는 관점 설정. (커머스형은 위 7단계 템플릿 준수)
                STEP 4. 톤 앵커 고정: 1인칭 유지. 확신하는 어미 제거. 느낌표 2개 이상 금지.
                STEP 5. 초안 작성: "저는 / 그날 / 생각해보니" 등 장면 묘사 중심.
                STEP 6. 「했어요, 그랬나요?」 필터링 적용: 
                    - "했어요", "그랬나요?", "잘 모르겠어요", "그런 것 같기도 해요" 등의 어미를 자연스럽게 섞을 것.
                    - "추천합니다 / 필수 / 강력" 등 단정적이고 강요하는 표현 절대 금지.
