...
"[project]/src/app/[locale]/admin/login/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LoginPage() {
    ...
    const handleGoogleLogin = async ()=>{
        ...
        setError('');
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginWithGoogle"])('admin');
            router.push(`/${locale}/admin`);
        } catch (err) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            if (isLogin) {
                ...
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["registerWithEmail"])(email, password, displayName, 'admin');
...
//# sourceMappingURL=_c686644d._.js.map