...
function AdminLayout({ children }) {
    _s();
    const { user, profile, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
            ...
            if (!loading) {
                if (!user && !pathname.includes('/login')) {
                    ...
                    if (profile.role === 'admin' && profile.status === 'pending' && !pathname.includes('/login')) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logout"])();
                        router.push(`/${locale}/admin/login`);
                    }
                }
            }
...
_s(AdminLayout, "QoH51EUKyND9gHKhbjR1r4NwyvU=", false, function() {
    return [
...
//# sourceMappingURL=_5b69fffa._.js.map