...
// Dummy data for initial development when DB is empty
const DUMMY_POSTS = [
    {
        id: '1',
        title: '제주도 여행 가이드: 꼭 가봐야 할 명소 5곳',
        content: '제주도 여행을 계획하고 계신가요? 이번 포스팅에서는...',
        summary: '제주도 여행의 필수 코스를 소개합니다.',
        category: 'TRAVEL',
        tags: [
            '제주도',
            '여행',
    ...
    {
        id: '2',
        title: '2024년 봄 패션 트렌드 분석',
        content: '올해 봄에는 어떤 스타일이 유행할까요?',
        summary: '2024년 봄을 강타할 패션 트렌드 미리보기',
        category: 'SHOPPING',
        tags: [
            '패션',
            '트렌드',
        ...
        status: 'published',
        viewCount: 85,
        slug: '2024-spring-fashion',
        thumbnailUrl: 'https://images.unsplash.com/photo-1483985988355-763728e1935b?q=80&w=800&auto=format&fit=crop'
    },
    {
        id: '3',
        title: '자취생을 위한 간단 요리: 김치볶음밥',
        content: '냉장고에 남은 김치로 만드는 최고의 요리...',
        summary: '누구나 쉽게 따라할 수 있는 김치볶음밥 레시피',
        category: 'COOKING',
        tags: [
            '요리',
            '자취',
        ...
        status: 'published',
        viewCount: 230,
        slug: 'simple-kimchi-fried-rice',
        thumbnailUrl: 'https://images.unsplash.com/photo-1564834724105-918b73d1b9e0?q=80&w=800&auto=format&fit=crop'
    },
    {
        id: '4',
        title: 'Next.js 15 새로운 기능 살펴보기',
        content: 'Next.js 15가 출시되었습니다. 주요 변경 사항은...',
        summary: 'Next.js 15의 핵심 기능을 정리해봅니다.',
        category: 'ISSUE',
        tags: [
            'Next.js',
            'Tech',
    ...
    {
        id: '5',
        title: '효율적인 블로그 운영 기획',
        content: '블로그를 처음 시작할 때 가장 중요한 것은...',
        summary: '성공적인 블로그 운영을 위한 기획 단계 가이드',
        category: 'PLANNING',
        tags: [
            '기획',
            '블로그',
...
const getPosts = async (category = 'ALL')=>{
    try {
        ...
        if (snapshot.empty) {
            console.log("Firestore is empty, returning dummy data");
            // Filter dummy data
            if (category === 'ALL') return DUMMY_POSTS;
            return DUMMY_POSTS.filter((p)=>p.category === category);
        }
        ...
        // Fallback to dummy data on error (e.g. permission denied)
        if (category === 'ALL') return DUMMY_POSTS;
        return DUMMY_POSTS.filter((p)=>p.category === category);
    }
};
...
"[project]/src/components/blog/PostList.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$blog$2f$CategoryFilter$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/blog/CategoryFilter.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$blog$2f$PostCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/blog/PostCard.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function PostList() {
    ...
    const { data: posts, isLoading, isError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'posts',
            category
        ],
        queryFn: {
            "PostList.useQuery": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$blogService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPosts"])(category)
        }["PostList.useQuery"]
    });
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "w-full max-w-7xl mx-auto px-4 py-8",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$blog$2f$CategoryFilter$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CategoryFilter"], {
            ...
            !isLoading && !isError && posts && posts.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            !isLoading && posts && posts.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",
                children: posts.map((post)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$blog$2f$PostCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PostCard"], {
                        post: post
                    }, post.id, false, {
                        fileName: "[project]/src/components/blog/PostList.tsx",
                        lineNumber: 45,
...
_s(PostList, "/nv3FD0gDxL1kI6ExSYv8uxBaJk=", false, function() {
    return [
...
//# sourceMappingURL=src_b7ce69ef._.js.map