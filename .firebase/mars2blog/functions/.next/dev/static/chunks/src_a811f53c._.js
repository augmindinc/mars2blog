...
function TiptapEditor({ content, onChange }) {
    ...
    const addImage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TiptapEditor.useCallback[addImage]": (e)=>{
            e.preventDefault();
    ...
    const addYoutube = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TiptapEditor.useCallback[addYoutube]": (e)=>{
            e.preventDefault();
    ...
    }["TiptapEditor.useCallback[addYoutube]"], [
        editor
    ]);
    if (!editor) {
        return null;
...
_s(TiptapEditor, "MBDSqPWwmjGCDDJlm3+z1rj6CwM=", false, function() {
    return [
...
_s(WritePage, "mw4tVgTnIk+KogIRmgwS76lk+Ww=", false, function() {
    return [
...
//# sourceMappingURL=src_a811f53c._.js.map